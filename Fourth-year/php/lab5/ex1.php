...
<body>
    <?php
        ...
        $queryCreateTable = "CREATE TABLE notebook (id INT NOT NULL AUTO_INCREMENT, PRIMARY KEY(id), name VARCHAR(50), city VARCHAR(50), address VARCHAR(50), birthday DATE, mail VARCHAR(50))";
